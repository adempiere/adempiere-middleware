...
sed -i "s|adempiere_token_value|$AD_TOKEN|g" env.yaml
...
sed -i "s|$DEFAULT_JAVA_OPTIONS|$GRPC_JAVA_OPTIONS|g" bin/adempiere-middleware-server

# Run app
bin/adempiere-middleware-server env.yaml
